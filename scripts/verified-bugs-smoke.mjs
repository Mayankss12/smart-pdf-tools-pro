...
assert.match(objectFrame, /role="group"/);
assert.match(objectFrame, /aria-label=\{`\$\{toolbarLabel\} object/);
...
assert.match(pdfWordRegistry, /Editable-layout mode preserves page graphics and positioning/);
