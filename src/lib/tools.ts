...
const existingTools: Tool[] = [
  ...
  },
  {
    ...
    menuDescription: "Backend configuration required for authorized watermark removal.",
    category: "security",
    ...
    isClientOnly: false,
    newTool: true,
    search: searchMeta(["remove watermark", "watermark remover", "delete watermark"], ["authorized cleanup", "stamp removal", "backend"], ["remove watermark from my pdf", "clean up authorized document"], 103),
    visibility: directoryOnly,
