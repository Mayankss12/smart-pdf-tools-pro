...
const existingTools: Tool[] = [
  ...
  },
  {
    id: "jpg-to-pdf",
    title: "JPG to PDF",
    description: "Convert JPG photos, scans, or screenshots into a clean PDF.",
    menuDescription: "Turn JPG images into a PDF document.",
    category: "convert",
    ...
    popular: true,
    newTool: true,
    search: searchMeta(["jpg to pdf", "jpeg to pdf", "photo to pdf"], ["jpg", "jpeg", "photos", "scans", "screenshots"], ["convert jpg images to pdf", "make pdf from jpeg photos"], 107),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing", "tool-page", true),
  },
  {
    id: "png-to-pdf",
    title: "PNG to PDF",
    description: "Convert PNG images, screenshots, or transparent graphics into a PDF.",
    menuDescription: "Turn PNG images into a PDF document.",
    category: "convert",
    ...
    popular: true,
    newTool: true,
    search: searchMeta(["png to pdf", "screenshot to pdf", "image to pdf"], ["png", "screenshots", "transparent images"], ["convert png images to pdf", "make pdf from screenshots"], 106),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing", "tool-page", true),
  },
  {
  ...
  },
  {
    id: "pdf-to-jpg",
    title: "PDF to JPG",
    description: "Export PDF pages as JPG images for sharing, upload, or preview.",
    menuDescription: "Convert PDF pages into JPG images.",
    category: "convert",
    ...
    popular: true,
    newTool: true,
    search: searchMeta(["pdf to jpg", "pdf to jpeg", "convert pdf to jpg"], ["jpg", "jpeg", "export image", "render pages"], ["save pdf pages as jpg", "convert pdf into jpeg images"], 94),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    id: "pdf-to-png",
    title: "PDF to PNG",
    description: "Export PDF pages as PNG images with crisp quality.",
    menuDescription: "Convert PDF pages into PNG images.",
    category: "convert",
    ...
    popular: true,
    newTool: true,
    search: searchMeta(["pdf to png", "convert pdf to png"], ["png", "export image", "render pages"], ["save pdf pages as png", "convert pdf into png images"], 93),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    id: "text-to-pdf",
    title: "Text to PDF",
    description: "Turn plain text into a clean, paginated PDF in your browser.",
    menuDescription: "Create a downloadable PDF from typed or pasted text.",
    category: "convert",
    ...
    isClientOnly: true,
    search: searchMeta(
      ["text to pdf", "create pdf from text"],
      ["plain text", "document creation", "browser"],
      ["turn notes into a pdf", "create a text document"],
      92,
    ),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
