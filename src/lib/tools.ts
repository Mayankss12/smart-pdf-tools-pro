...
const existingTools: Tool[] = [
  ...
  },
  {
    ...
    title: "Compare PDFs",
    shortTitle: "Compare",
    description: "Compare two PDF versions page by page with visual and text differences.",
    menuDescription: "Review visual and text changes between two PDF versions.",
    category: "edit",
    href: "/tools/compare",
    icon: FileDiff,
    status: "working",
    isClientOnly: true,
    newTool: true,
    search: searchMeta(["compare pdf", "pdf diff", "document comparison"], ["changes", "revision", "visual diff", "text diff"], ["compare two pdf versions", "find changes in a pdf"], 103),
    visibility: everywhere,
    capabilities: browserTool("workspace", "tool-page", true),
  },
  {
    id: "form-creator",
    title: "PDF Form Creator",
    shortTitle: "Form Creator",
    description: "Add real interactive text, checkbox, dropdown, and radio fields to a PDF.",
    menuDescription: "Build interactive AcroForm fields directly on PDF pages.",
    category: "edit",
    ...
    isClientOnly: true,
    newTool: true,
    search: searchMeta(["create pdf form", "fillable pdf", "acroform"], ["form field", "checkbox", "dropdown", "radio", "interactive"], ["make a fillable pdf", "add form fields to pdf"], 102),
    visibility: everywhere,
    capabilities: browserTool("workspace"),
  },
  {
    ...
    shortTitle: "PDF/A",
    description: "Inspect archival-readiness risks and prepare a safer archival copy without false certification claims.",
    menuDescription: "Check PDF/A readiness and remove selected archival blockers.",
    category: "optimize",
    href: "/tools/pdfa",
    icon: Archive,
    status: "working",
    isClientOnly: true,
    newTool: true,
    search: searchMeta(["pdf a", "pdf/a", "archival pdf", "archive pdf"], ["preflight", "standards", "long term preservation", "metadata"], ["check pdf for archiving", "prepare archival pdf"], 101),
    visibility: everywhere,
  ...
  },
  {
    id: "protect-pdf",
    title: "Protect PDF",
    description: "Add AES-256 password encryption and document permissions locally.",
    menuDescription: "Password protect PDFs locally with verified AES-256 encryption.",
    category: "security",
    href: "/tools/protect",
    icon: ShieldCheck,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["password pdf", "lock pdf", "secure pdf"], ["protection", "document security", "password access", "aes 256"], ["password protect a pdf", "secure document before sharing"], 101),
    visibility: everywhere,
    capabilities: browserTool("guided-processing"),
  },
  {
    id: "unlock-pdf",
    title: "Unlock PDF",
    description: "Remove a known PDF password and usage restrictions locally.",
    menuDescription: "Unlock an authorized PDF locally when you know its password.",
    category: "security",
    href: "/tools/unlock",
    icon: ShieldOff,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["remove pdf password", "unlock protected pdf", "password remover"], ["password removal", "authorized access", "decrypt pdf"], ["unlock my own pdf", "remove protection from document I own"], 99),
    visibility: everywhere,
    capabilities: browserTool("guided-processing"),
  },
  {
    ...
    description: "Remove PDFMantra-tagged watermarks and standard watermark annotations locally.",
    menuDescription: "Remove compatible watermark objects from an authorized PDF.",
    category: "security",
    ...
    isClientOnly: true,
    newTool: true,
    search: searchMeta(["remove watermark", "watermark remover", "delete watermark"], ["authorized cleanup", "stamp removal", "PDF annotation"], ["remove watermark from my pdf", "clean up authorized document"], 103),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    id: "redact-pdf",
    title: "Redact PDF",
    description: "Permanently remove selected areas by rebuilding every page as a flattened image.",
    menuDescription: "Permanently remove sensitive visual content from a PDF.",
    category: "security",
    href: "/tools/redact",
    icon: Eye,
    status: "working",
    isClientOnly: true,
    popular: true,
    search: searchMeta(["hide private text", "remove sensitive data", "blackout pdf", "redact pdf"], ["privacy", "permanent removal", "sensitive information", "flattened output"], ["redact personal data", "hide confidential text permanently"], 104),
    visibility: everywhere,
    capabilities: browserTool("workspace"),
  },
  {
    id: "crop-pdf",
    title: "Crop PDF",
    description: "Apply precise crop margins while preserving vector text and image quality.",
    menuDescription: "Crop page margins without rasterizing the document.",
    category: "organize",
    href: "/tools/crop",
    icon: Crop,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["crop pages", "trim pdf", "page margins"], ["crop box", "margin", "page size"], ["remove page margins", "crop scanned borders"], 91),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    id: "flatten-pdf",
    title: "Flatten PDF",
    description: "Freeze form fields and annotations into page content.",
    menuDescription: "Make PDF fields and annotations non-editable before sharing.",
    category: "optimize",
    href: "/tools/flatten",
    icon: FileCheck2,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["flatten pdf", "freeze form", "flatten annotations"], ["form fields", "annotations", "printing"], ["make pdf fields permanent", "prepare pdf for printing"], 94),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    id: "repair-pdf",
    title: "Repair PDF",
    description: "Rebuild recoverable PDF cross-reference and structural data.",
    menuDescription: "Repair recoverable structural problems in damaged PDFs.",
    category: "optimize",
    href: "/tools/repair",
    icon: Wrench,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["fix pdf", "repair damaged pdf", "recover pdf"], ["xref", "damaged", "corrupt", "structure"], ["open a damaged pdf", "repair pdf errors"], 93),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    ...
    description: "Inspect, update, or remove PDF document properties.",
    menuDescription: "Edit title, author, subject, keywords, creator, and producer.",
    category: "edit",
    href: "/tools/metadata",
    icon: FileCog,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["pdf properties", "remove metadata", "edit author"], ["title", "author", "subject", "keywords"], ["clean pdf metadata", "change document author"], 89),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    ...
    description: "Add padded, prefixed audit numbering across PDF pages.",
    menuDescription: "Apply consistent Bates identifiers for legal and office documents.",
    category: "edit",
    href: "/tools/bates-numbering",
    icon: Hash,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["bates stamp", "legal numbering", "document numbering"], ["prefix", "sequence", "audit", "legal"], ["bates number legal documents", "number evidence pages"], 92),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    id: "advanced-split",
    title: "Advanced Split PDF",
    shortTitle: "Advanced Split",
    description: "Split PDFs by approximate size, bookmarks, or matching page text.",
    menuDescription: "Create parts from size targets, bookmarks, or page text.",
    category: "organize",
    href: "/tools/advanced-split",
    icon: BookOpen,
    status: "working",
    isClientOnly: true,
    search: searchMeta(["split by size", "split bookmarks", "split by text"], ["bookmark", "file size", "chapter", "text match"], ["split a large pdf by mb", "split chapters from bookmarks"], 96),
    visibility: directoryOnly,
    capabilities: browserTool("guided-processing"),
  },
  {
    ...
    shortTitle: "Batch PDFs",
    description: "Apply one operation to many PDFs or chain operations on one file.",
    menuDescription: "Automate repeatable local PDF processing for office work.",
    category: "optimize",
    href: "/tools/batch-workflows",
    icon: Files,
    status: "working",
    isClientOnly: true,
    maxFiles: 20,
    search: searchMeta(["batch pdf", "pdf workflow", "bulk pdf"], ["automation", "multiple files", "pipeline", "office"], ["repair many pdfs", "chain pdf operations"], 95),
    visibility: directoryOnly,
    capabilities: browserTool("workspace", "tool-page", true),
  },
];
